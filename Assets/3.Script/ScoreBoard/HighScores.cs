...
{
    const string privateCode = "lWzICd27H0Kg_NIAvSoYjAzrryFQo9KUmoTJa-vdf-cQ";  //Key to Upload New Info
    const string publicCode = "64560bbe8f40bb6dec882db9";   //Key to download
